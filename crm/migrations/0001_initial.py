    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_date', models.DateTimeField(auto_created=True, auto_now=True, verbose_name='Created date')),
                ('name', models.CharField(default=None, max_length=512, null=True, verbose_name='name')),
                ('description', models.CharField(default=None, max_length=2048, null=True, verbose_name='Description')),
                ('updated_date', models.DateTimeField(blank=True, null=True, verbose_name='Updated date')),
                ('bank', models.ManyToManyField(related_name='company_bank_list', to='crm.Bank', verbose_name='Bank list')),
            ],
        ),
        migrations.CreateModel(
            name='Province',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=1024, verbose_name='Description')),
                ('province', models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.province', verbose_name='Region')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('organization', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='profile_organization', to='crm.organization', verbose_name='Works in')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_created=True, auto_now=True, verbose_name='Created date')),
                ('updated_date', models.DateTimeField(blank=True, null=True, verbose_name='Updated date')),
                ('bank', models.ManyToManyField(related_name='p_bank_list', to='crm.Bank', verbose_name='Bank list')),
        ...
        migrations.AddField(
            model_name='address',
            name='location',
            field=models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.region', verbose_name='Region'),
        ),
    ]
