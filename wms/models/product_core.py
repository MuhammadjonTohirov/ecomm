...
class ProductCore(models.Model):
    ...
    description = models.CharField(
        verbose_name='Description', default=None, blank=True, max_length=1024, null=True)

    image = models.ImageField(
        verbose_name='Image', upload_to='images/products/', blank=True, null=True)

    tag = models.CharField(verbose_name='Tag', default=None,
                           blank=True, max_length=256, null=True)

    color = models.ForeignKey(
        to='Color', on_delete=models.SET_NULL, blank=True, default=None, null=True)
    ...
    categories = models.ManyToManyField(
        to=ProductCategory, verbose_name='Category', blank=True, default=None, related_name='categories')
